...
<div id="page-wrapper">
    <div class="container-fluid">
    	<div class="row">
        	<div class="col-lg-12">
                <h1 class="page-header">Add Myecotrip admin</h1>
            </div>
        </div>
         @if(Session::has('message'))
			<p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('message') }}</p>
		@endif
		{{ Form::open(array('url' => 'admin/createMyAdmin')) }}
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				<input type="text" class="form-control" id="designation" placeholder="Admin Name" name="designation">
			</div>
			</div>
		</div>
