<html>
    <head>
        <title>Myecotrip |Birdsanctuary Admin</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                    	...
                    	<img class="navbarLogo" style="float:right" src="{{asset('assets/Admin/img/myecotrip/Karnataka_Forest_Department_Logo_2016.png') }}" alt="Image Alternative text" title="Image Title" />
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post" action="{{url('/')}}/bs-admin/doLogin">
                            <fieldset>
