...
<!-- Mirrored from remtsoy.com/tf_templates/traveler/demo_v1_7/index-7.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 30 Jul 2017 10:35:37 GMT -->
<head>
...
<body>
    ...
    <div class="global-wrap">
        <div class="demo_changer" id="demo_changer">
            ...
            <div class="form_holder">
                ...
                <div class="predefined_styles" id="styleswitch_area">
                    <a class="styleswitch" href="index-7c392.html?default=true" style="background:#ED8323;"></a>
                ...
                <div class="predefined_styles" id="patternswitch_area">
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/binding_light.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/binding_dark.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/dark_fish_skin.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/dimension.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/escheresque_ste.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/food.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/giftly.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/grey_wash_wall.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/ps_neutral.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/pw_maze_black.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/pw_pattern.png') }});"></a>
                    <a class="patternswitch" href="#" style="background-image: url({{asset('assets/img/patterns/simple_dashed.png') }});"></a>
                </div>
                <div class="line"></div>
                <p>Background Images</p>
                <div class="predefined_styles" id="bgimageswitch_area">
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/bike.jpg') }});" data-src="img/backgrounds/bike.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/flowers.jpg') }});" data-src="img/backgrounds/flowers.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/wood.jpg') }});" data-src="img/backgrounds/wood.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/taxi.jpg') }});" data-src="img/backgrounds/taxi.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/phone.jpg') }});" data-src="img/backgrounds/phone.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/road.jpg') }});" data-src="img/backgrounds/road.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/keyboard.jpg') }});" data-src="img/backgrounds/keyboard.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/beach.jpg') }});" data-src="img/backgrounds/beach.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/street.jpg') }});" data-src="img/backgrounds/street.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/nature.jpg') }});" data-src="img/backgrounds/nature.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/bridge.jpg') }});" data-src="img/backgrounds/bridge.jpg"></a>
                    <a class="bgimageswitch" href="#" style="background-image: url({{asset('assets/img/switcher/cameras.jpg') }});" data-src="img/backgrounds/cameras.jpg"></a>
                </div>
                <div class="line"></div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <a class="logo" href="index.html">
                                <img src="{{asset('assets/img/logo-invert.png') }} " alt="Image Alternative text" title="Image Title" />
                            </a>
                        </div>
                                ...
                                <ul class="top-user-area-list list list-horizontal list-border">
                                    <li class="top-user-area-avatar">
                                        <a href="user-profile.html">
                                            <img class="origin round" src="{{ asset('assets/img/amaze_40x40.jpg') }} " alt="Image Alternative text" title="AMaze" />Hi, John</a>
                                    </li>
                                    ...
                                    <li class="top-user-area-lang nav-drop">
                                        <a href="#">
                                            <img src="{{asset('assets/img/flags/32/uk.png') }} " alt="Image Alternative text" title="Image Title" />ENG<i class="fa fa-angle-down"></i><i class="fa fa-angle-up"></i>
                                        </a>
                                        <ul class="list nav-drop-menu">
                                            <li>
                                                <a title="German" href="#">
                                                    <img src="{{asset('assets/img/flags/32/de.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">GER</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Japanise" href="#">
                                                    <img src="{{asset('assets/img/flags/32/jp.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">JAP</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Italian" href="#">
                                                    <img src="{{asset('assets/img/flags/32/it.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">ITA</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="French" href="#">
                                                    <img src="{{asset('assets/img/flags/32/fr.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">FRE</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Russian" href="#">
                                                    <img src="{{asset('assets/img/flags/32/ru.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">RUS</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a title="Korean" href="#">
                                                    <img src="{{asset('assets/img/flags/32/kr.png') }} " alt="Image Alternative text" title="Image Title" /><span class="right">KOR</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
            ...
            <div class="bg-holder full">
                ...
                <div class="owl-carousel owl-slider owl-carousel-area visible-lg" id="owl-carousel-slider" data-nav="false">
                    <div class="bg-holder full">
                        ...
                        <div class="bg-img" style="background-image:url({{asset('assets/img/196_365_2048x1365.jpg') }});"></div>
                    </div>
                    <div class="bg-holder full">
                        <div class="bg-mask"></div>
                        <div class="bg-img" style="background-image:url({{asset('assets/img/el_inevitable_paso_del_tiempo_2048x2048.jpg') }});"></div>
                    </div>
                    <div class="bg-holder full">
                        <div class="bg-mask"></div>
                        <div class="bg-img" style="background-image:url({{asset('assets/img/viva_las_vegas_2048x1365.jpg') }});"></div>
                    </div>
                </div>
                <div class="bg-img hidden-lg" style="background-image:url({{asset('assets/img/196_365_2048x1365.jpg') }});"></div>
        ...
        <div class="bg-holder">
            <div class="bg-mask"></div>
            <div class="bg-img" style="background-image:url({{asset('assets/img/hotel_porto_bay_liberdade_2048x1293.jpg') }});"></div>
                ...
                <div class="row row-wrap">
                        ...
                        <div class="thumb">
                            <header class="thumb-header">
                                <a class="hover-img curved" href="#">
                                    <img src="{{asset('assets/img/people_on_the_beach_800x600.jpg') }} " alt="Image Alternative text" title="people on the beach" />
                                </a>
                            </header>
                            <div class="img-left">
                                <img src="{{asset('assets/img/flags/32/gr.png') }} " alt="Image Alternative text" title="Image Title" />
                            </div>
                            <div class="thumb-caption">
                    ...
                    <div class="col-md-3">
                        <div class="thumb">
                            <header class="thumb-header">
                                <a class="hover-img curved" href="#">
                                    <img src="{{asset('assets/img/196_365_800x600.jpg') }} " alt="Image Alternative text" title="196_365" />
                                </a>
                            </header>
                            <div class="img-left">
                                <img src="{{asset('assets/img/flags/32/fr.png') }} " alt="Image Alternative text" title="Image Title" />
                            </div>
                            <div class="thumb-caption">
                    ...
                    <div class="col-md-3">
                        <div class="thumb">
                            ...
                            <div class="img-left">
                                <img src="{{asset('assets/img/flags/32/hu.png') }} " alt="Image Alternative text" title="Image Title" />
                            </div>
                            <div class="thumb-caption">
                    ...
                    <div class="col-md-3">
                        <div class="thumb">
                            ...
                            <div class="img-left">
                                <img src="{{asset('assets/img/flags/32/us.png') }} " alt="Image Alternative text" title="Image Title" />
                            </div>
                            <div class="thumb-caption">
