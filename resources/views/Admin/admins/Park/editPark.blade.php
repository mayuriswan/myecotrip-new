...
<div id="page-wrapper">
    <div class="container-fluid">
    	<div class="row">
        	<div class="col-lg-12">
                <h1 class="page-header">Edit park admin</h1>
            </div>
        </div>
		{{ Form::open(array('url' => 'admin/updateParkAdmin')) }}
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				<select class="form-control" required name="park_id">
					<option>Select the park</option>
					@foreach($parkList as $park)
						<option @if($adminData['park_id'] == $park['id']) selected @endif value="{{$park['id']}}">{{$park['name']}}</option>
					@endforeach
				</select>
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-5">
				<select class="form-control" required name="designation">
					...
					<option @if($adminData['designation'] == "DFO office") selected @endif value="DFO office">DFO office</option>
				</select>
			</div>
		</div>
