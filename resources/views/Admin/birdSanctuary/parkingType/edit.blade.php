...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Edit Parking Type</h1>
				</div>
			</div>
			<div class="form-group row">
				{{ Form::open(array('url' => 'admin/updateParkingType', 'files' => true)) }}
				<input type="hidden" name="parkingTypeId" value="{{$parkingTypeData['id']}}">
				<div class="row">
					<div class="col-lg-12">
												...
												<div id="myTabContent" class="tab-content" style="margin-top: 3%;    margin-bottom: 3%;">
													<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
														...
														<div class="row">
															...
															<div class="col-xs-9"> <input name="type" type="text" class="form-control validate[required] text-input" id="type" value="{{ $parkingTypeData['type']}}" required>
															</div>
														</div>
														<br>
														<div class="row">
															...
															<div class="col-xs-9">
																<select class="form-control" name="isActive" id="isActive" required>
																	<option @if ($parkingTypeData['isActive'] == 1) selected @endif value="1">Yes</option>
																	<option @if ($parkingTypeData['isActive'] == 0) selected @endif value="0">No</option>
																</select>
															</div>
														</div>
														<br>
