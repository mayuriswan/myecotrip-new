...
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Room Pricing
                </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    ...
    <div class="row">
		<div class="col-lg-12">
            {{ Form::open(array('url' => 'cms/jungle-stay/pricing', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'product_form', 'enctype'=>'multipart/form-data')) }}
							...
							<div class="panel-heading">
								<h3>
									<div class='pull-right'>
										...
										<a href="{{Session::get('backUrl')}}" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Close</a>
									</div>
									Pricing details
								</h3>
							</div>
							<div class="panel-body">
                                ...
                                <div class="form-group">
                    		      	...
                    		      	<div class="col-sm-6 input-group">
                                        ...
                                        <select id="dates-field2" name="pricing_id" class="form-control" required>
                                            <option value="">Select type</option>
                                            @foreach($data['pricingMaster'] as $key => $row)
