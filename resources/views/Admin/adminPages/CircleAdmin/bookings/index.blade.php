            ...
            <div class="panel-body">
               <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody class="tblFont">
                     ...
                     <tr class="odd gradeX">
                        <!-- <td>{{$index + 1}}</td> -->
                        <td class="text-center"><a href="{{ url('circleAdmin/CAtrailDetail/') }}/{{$booking['id']}}/{{$booking['user_id']}}" title="Edit"><i class="fa fa-eye fa-fw"></i></a></td>
                        <td>{{$booking['display_id']}}</td>
                        <td>{{$booking['userData']['first_name']}}</td>
                        <!-- <td>{{$booking['userData']['email']}}</td> -->
                        <td>{{$booking['userData']['contact_no']}}</td>
                        <td>{{$booking['circleName']}}</td>
