            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Time Slots
                        <a href="{{ url('admin/addEcotrailTimeSlots') }}" title="Add Time Slots">
                ...
                <div class="modal fade" id="addNew" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            ...
                            {{ Form::open(array('url' => 'admin/addEcoTrailTimeSlots')) }}
                                ...
                                @if(count($timeSlotsList) > 0)
                                    @foreach($timeSlotsList as $index => $timeSlots)
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a href="{{ url('admin/editEcotrailTimeSlots?id=') }}{{$timeSlots['id']}}"  title="Edit"><i class="fa fa-edit fa-fw"></i></a>
                                                &nbsp;
    ...
    <script>
        $(".timeSlotsDelete").on("click", function(){
            ...
            if (decision) {
                ...
                window.location.href = "{{URL::to('admin/deleteEcotrailTimeSlots?id=')}}" + timeslotId
            }
        });
    </script>
