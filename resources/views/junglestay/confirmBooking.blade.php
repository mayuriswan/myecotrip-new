...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <h3>Confirm Visitor's Details:</h3>
             
                <form action="initiateJungleStayBooking" method="POST">
                ...
                <div class="booking-item-payment">
                    <header class="clearfix">
                        <a class="booking-item-payment-img" href="#">
                            <img src="{{asset($displayData['stayLogo'])}}" alt="Image Alternative" title="" />
                        </a>
                    ...
                    <ul class="booking-item-payment-details">
                        <li>
                            ...
                            <ul class="booking-item-payment-price">
                                ...
                                <li>
                                    <p class="booking-item-payment-price-title">JungleStay Name</p>
                                    <p class="booking-item-payment-price-amount">{{$displayData['stayName']}}
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p class="booking-item-payment-price-title">Number of Tickets<Stays></Stays></p>
                        ...
                        <li>
                            ...
                            <ul class="booking-item-payment-price">
                                <li>
                                    <p class="booking-item-payment-price-title">JungleStay Fee</p>
                                    <p class="booking-item-payment-price-amount">&#8377 {{$feeDetails['jungleStayFee']}}
                                    </p>
                                </li>
                                <li>
                                    <p class="booking-item-payment-price-title">StayType Fee</p>
                                    <p class="booking-item-payment-price-amount">&#8377 {{$feeDetails['stayTypeFee']}}
                                    </p>
                                </li>
                                <li>
