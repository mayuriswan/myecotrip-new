    	...
    	<div class="row">
        	<div class="col-lg-12">
                <h1 class="page-header">Landscapes
                    <a href="{{ url('admin/addJungleStayLandscape') }}" title="Add landscape">
			...
			<div class="modal fade" id="addNew" role="dialog">
				<div class="modal-dialog">
				  ...
				  <div class="modal-content">
		    		...
		    		{{ Form::open(array('url' => 'admin/addJungleStayLandscape')) }}
                            ...
                            @if(count($landscapeList) > 0)
                            	@foreach($landscapeList as $index => $landscape)
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                        	<a href="{{ url('admin/editJungleStayLandscape?id=') }}{{$landscape['id']}}"  title="Edit"><i class="fa fa-edit fa-fw"></i></a>
                                            &nbsp;
...
<script>
    $(".landscapeDelete").on("click", function(){
        ...
        if (decision) {
            ...
            window.location.href = "{{URL::to('admin/deleteJungleStayLandscape?id=')}}" + landscapeId
        }
    });
</script>
