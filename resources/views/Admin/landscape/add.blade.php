    	...
    	<div class="row">
        	<div class="col-lg-12">
                <h1 class="page-header">Add Landscape
                    <a href="{{ url('admin/addLandscape') }}" title="Edit">
				                  ...
				                  <div id="myTabContent" class="tab-content" style="margin-top: 3%;    margin-bottom: 3%;">
				                     <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
				                        <div class="row">
				                           ...
				                           <div class="col-xs-9"> <input name="display_order_no" required type="number" min="0" class="form-control validate[required] text-input" id="orderno">
				                           </div>
				                        </div>
				                        <br>
				                        <div class="row">
