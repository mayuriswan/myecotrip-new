...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Create Timeslot
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            {{ Form::open(array('url' => 'cms/ecotrails/timeslot', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'product_form', 'enctype'=>'multipart/form-data')) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-5"> <input name="timeslots" type="text" class="form-control " id="name" required>
                                </div>
                            </div>
                            <br>
