...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Add Camera Type
						<a href="{{ url('admin/addCameraType') }}" title="Add">
									...
									<div class="panel-heading">
										<h3>
											<div class='pull-right'>
												...
												<a href="cameraType" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Close</a>
											</div>
											Camera Type Details
										</h3>
									</div>
