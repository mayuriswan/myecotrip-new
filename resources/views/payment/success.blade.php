    ...
    <div class="container">
	   <div class="row">
	      <div class="col-md-8 col-md-offset-2">
	         ...
	         <h2 class="text-center">{{Session::get('userName')}}, your payment was successful & your booking is confirmed!</h2>
	         <h5 class="text-center mb30">Booking details have been sent to registered Email Address</h5>
	         <h5 class="text-center mb30">Please make sure you get a soft/hard copy of this mail for verification.</h5>
			  <!-- <p style="text-align:  center;"><b style="color: #e34a21;">Note for Gmail users: </b> For the last couple of days, our booking confirmation emails seem to be landing in Gmail's SPAM folder. Please check your SPAM folder for booking details and kindly mark it as not spam.
			  </p> -->
