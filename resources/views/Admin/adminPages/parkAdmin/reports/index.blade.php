...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <form action="downloadReport" method="POST">
        	<div class="row">
            <input type="hidden" name="requestFrom" value="parkAdmin">
        	<div class="container">
			   	 <div class="row">
                    <div class="col-sm-3">
                        <select name="trail" class="col-sm-3 form-control" required>
                            <option value="">Select Trail</option>
                            <option value="All_{{$allValue}}">All</option>
                            @foreach($traillist as $id => $trailName)
                                <option value="{{$id}}_{{$trailName}}">{{$trailName}}</option>
                            @endforeach
                        </select>
                    </div>
			   	 	<div class="col-sm-3">
