...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Add Camera Fee
						<a href="{{ url('admin/addCameraFee') }}" title="Add">
			...
			<div class="row">
				<div class="col-lg-12">
					<form action="{{url('/')}}/admin/createCameraFee" method="post" enctype="multipart/form-data">
									...
									<div class="panel-heading">
										<h3>
											<div class='pull-right'>
												...
												<a href="{{url('/')}}/admin/cameraFee/{{$birdSancturyId}}" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Close</a>
											</div>
											Camera Fee Details
										</h3>
									</div>
