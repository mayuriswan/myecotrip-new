...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Add Vehicle Type
						<a href="{{ url('admin/addParkingVehicleType') }}" title="Add">
									...
									<div class="panel-heading">
										<h3>
											<div class='pull-right'>
												...
												<a href="parkingVehicleType" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Close</a>
											</div>
