...
<body>
    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="details">
                <td>No of Tickets</td>
                <td>{{$bookingData['no_of_stays']}}</td>
            </tr>
            <tr>
                <td>JungleStay Entry Fee</td>
                <td>&#8377; {{$bookingData['junglestayFee']}}</td>
            </tr>
            <tr>
                <td>Stay Type Fee</td>
                <td>&#8377; {{$bookingData['stayTypeFee']}}</td>
            </tr>
            <tr class="details">
                <td>Service charges</td>
                <td>&#8377; {{$bookingData['service_charge']}}</td>
            </tr>
            ...
            <tr class="details">
                <td>Name</td>
                <td>{{$jungleStayData['name']}}</td>
            </tr>
            <tr>
                <td>Stay type</td>
                <td>{{$jungleStayDetail['type']}}</td>
            </tr>
            <tr>
                <td>Check In</td>
                <td>{{$jungleStayData['checkIn']}}</td>
            </tr>
        </table>
        ...
        <table class="table" cellpadding="0" cellspacing="0">
            ...
            <?php $slNo = 1; ?>
            @foreach($jungleStayDetail['visitorsDetails'] as $visitors)
                <tr>
                    <td>{{$slNo}}</td>
