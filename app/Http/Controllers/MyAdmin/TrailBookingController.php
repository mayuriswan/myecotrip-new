...
class TrailBookingController extends Controller
{
    public function SAtrailBookings(Request $request)
    {
        ...
        try {
            ...
            return view('Admin/adminPages/myAdmin/bookings/index', ['getBooking'=> $returnData,'dashboardfData' =>$dashboardfData]);
        } catch (Exception $e) {
    ...
    public function SAtrailDetail(Request $request, $bookingId, $userId)
    {
        ...
        if ($request->session()->get('userId')) {
            try {
                ...
                return view('Admin/adminPages/myAdmin/bookings/bookingDetails', ['bookingData'=> $bookingData,'userData' =>$userData[0]]);
            } catch (Exception $e) {
                Session::flash('message', 'Sorry could not process. '. $e->getMessage()); 
                Session::flash('alert-class', 'alert-danger');  
                $data =  $request->session()->get('_previous');
    ...
    public function SApreBookings(Request $request)
    {
        ...
        if ($request->session()->get('userId')) {
            try {
                ...
                return view('Admin/adminPages/myAdmin/bookings/preBookings', ['getBooking'=> $returnData]);
            } catch (Exception $e) {
                Session::flash('message', 'Sorry could not process. '. $e->getMessage()); 
                Session::flash('alert-class', 'alert-danger');  
                $data =  $request->session()->get('_previous');
    ...
    public function SAplacedToday(Request $request)
    {
        ...
        if ($request->session()->get('userId')) {
            try {
                ...
                // echo "<pre>";print_r($returnData);exit();
                return view('Admin/adminPages/myAdmin/bookings/placedToday', ['getBooking'=> $returnData]);
            } catch (Exception $e) {
                Session::flash('message', 'Sorry could not process. '. $e->getMessage()); 
                Session::flash('alert-class', 'alert-danger');  
                $data =  $request->session()->get('_previous');
    ...
    public function getSearchedBookings(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            try {
                ...
                return view('Admin/adminPages/myAdmin/bookings/searchBooking', ['getBooking'=> $returnData, 'selectedDate' => $content]);
            } catch (Exception $e) {
                Session::flash('message', 'Sorry could not process. '. $e->getMessage()); 
                Session::flash('alert-class', 'alert-danger');  
                $data =  $request->session()->get('_previous');
