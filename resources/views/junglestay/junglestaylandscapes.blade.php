...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <h3 class="mb20">Popular JungleStays</h3>
                <hr>
                <div class="row row-wrap">
                    @foreach($landscapeList as $landscape)
                        <div class="col-md-4">
                            <div class="thumb">
                                <a class="hover-img" href="{{url('junglestays')}}/{{$landscape['id']}}/{{$landscape['name']}}">
                                    ...
                                    <div class="hover-inner hover-inner-block hover-inner-bottom hover-inner-bg-black hover-hold">
                                        <div class="text-small">
                                            ...
                                            @if ($landscape['stayCount'] > 0) <p class="mb0">{{$landscape['stayCount']}} trails</p> @endif
                                        </div>
                                    </div>
                                </a>
                            </div>
