...
@section('content')
	...
	<div id="page-wrapper">
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Add TimeSlots
						<a href="{{ url('admin/addEcotrailTimeSlots') }}" title="Edit">
			...
			<div class="row">
				<div class="col-lg-12">
					<form action="createEcotrailTimeSlots" method="post" enctype="multipart/form-data">
						<div class="row">
							<div class="col-lg-12">
											...
											<div id="myTabContent" class="tab-content" style="margin-top: 3%;    margin-bottom: 3%;">
												<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
													<div class="row">
														...
														<div class="col-xs-9">
															<input name="timeslots" type="text" class="form-control validate[required] text-input" id="timeslots" required>
														</div>
													</div>
													<br>
													<div class="row">
