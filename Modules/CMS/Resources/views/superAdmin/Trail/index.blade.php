            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Trails
                        <a href="{{url('/cms/ecotrails/trails/create')}}" title="Add new admin">
                            ...
                            <tbody class="tblFont">
                                @foreach($data as $key => $row)
                                    <tr>
                                        ...
                                        <td>
                                        	<a href="{{ url('cms/ecotrails/trails')}}/{{$row['id']}}/edit" title="Edit"><i class="fa fa-edit fa-fw"></i> Edit</a>
                                        </td>
                                        <td>
...
<script>
    ...
    $(".deleteRow").on("click", function(){
        ...
        if (decision) {
          ...
          type: "DELETE",
          url: "{{URL::to('cms/ecotrails/trails')}}/" + id,
