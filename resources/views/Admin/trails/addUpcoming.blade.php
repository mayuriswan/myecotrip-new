...
<div id="page-wrapper">
    <div class="container-fluid">
		...
		<div class="row">
            <div class="col-lg-12">
            	<form action="createTrailUpcoming" method="post" enctype="multipart/form-data">
				   <div class="row">
				      <div class="col-lg-12">
				                  ...
				                  <div id="myTabContent" class="tab-content" style="margin-top: 3%;    margin-bottom: 3%;">
				                     <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
				                        <div class="row">
				                           ...
				                           <div class="col-xs-9"> <input name="name" required type="text" class="form-control validate[required] text-input">
				                           </div>
				                        </div>
				                        <br>
				                        <div class="row">
				                           <div class="col-xs-3"><strong>Short Desc&nbsp;<span class="text-red dk-font-18">*</span>&nbsp;</strong></div>
				                           <div class="col-xs-9"> <input name="shortDesc" type="text" class="form-control validate[required] text-input" required>
				                           </div>
				                        </div>
				                        ...
				                        <div class="row">
				                           ...
				                           <div class="col-xs-9"> <input name="googleSearchText" type="text" class="form-control validate[required] text-input" required>
				                           </div>
				                        </div>
				                        <br>
