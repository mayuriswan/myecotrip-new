            ...
            <div class="panel-heading">
               <div class="row">
                  ...
                  <div class="col-xs-12 text-center">
                     <div class="medium"> {{$dashboardfData['bookingsForToday']}} / {{$dashboardfData['maxTrekkers']}}</div>
                     <div></div>
                  </div>
               </div>
            </div>
         ...
         <div class="panel panel-green">
            <div class="panel-heading">
               <div class="row">
                  ...
                  <div class="col-xs-12 text-center">
                     <div class="medium">{{$dashboardfData['bookingsForTom']}} / {{$dashboardfData['maxTrekkers']}}</div>
                     <div></div>
                  </div>
               </div>
            </div>
            <a href="TApreBookings">
               <div class="panel-footer">
               ...
               <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                  ...
                  <tbody class="tblFont">
                     ...
                     <tr class="odd gradeX">
                        ...
                        <td class="text-center"><a href="{{ url('admin/TAtrailDetail/') }}/{{$booking['id']}}/{{$booking['user_id']}}" title="Edit"><i class="fa fa-eye fa-fw"></i></a></td>
                     </tr>
                     @endforeach                                                          
                     @else
