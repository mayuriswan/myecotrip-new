...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Update Trail Upcoming
            </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            {{ Form::open(array('url' => 'cms/ecotrails/coming-soon/'.$data['id'], 'method' => 'PUT', 'class' => 'form-horizontal', 'id' => 'product_form', 'enctype'=>'multipart/form-data')) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-5"> <input name="shortDesc" type="text" class="form-control " id="name" required value="{{$data['shortDesc']}}">
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-5"> <input name="googleSearchText" required type="text" class="form-control " id="orderno" value="{{$data['googleSearchText']}}">
                                </div>
                            </div>
                            <br>
