	...
	<div id="page-wrapper">
		<div class="container-fluid">
			...
			<div class="form-group row">
				{{ Form::open(array('url' => 'admin/updateParkingVehicleType', 'files' => true)) }}
				<input type="hidden" name="parkingVehicleTypeId" value="{{$parkingVehicleTypeData['id']}}">
				<div class="row">
					<div class="col-lg-12">
						<form action="createParkingVehicleType" method="post" enctype="multipart/form-data">
							<div class="row">
								<div class="col-lg-12">
												...
												<div id="myTabContent" class="tab-content" style="margin-top: 3%;    margin-bottom: 3%;">
													<div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
														...
														<div class="row">
															...
															<div class="col-xs-9"> <input name="type" type="text" class="form-control validate[required] text-input" id="type" value="{{ $parkingVehicleTypeData['type']}}" required>
															</div>
														</div>
														<br>
														<div class="row">
															...
															<div class="col-xs-9">
																<select class="form-control" name="isActive" id="isActive" required>
																	<option @if ($parkingVehicleTypeData['isActive'] == 1) selected @endif value="1">Yes</option>
																	<option @if ($parkingVehicleTypeData['isActive'] == 0) selected @endif value="0">No</option>
																</select>
															</div>
														</div>
														<br>
