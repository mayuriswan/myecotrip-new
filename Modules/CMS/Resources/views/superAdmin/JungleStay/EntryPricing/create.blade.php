...
<div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Entry Pricing
                </h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
    ...
    <div class="row">
		<div class="col-lg-12">
            {{ Form::open(array('url' => 'cms/jungle-stay/entry', 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'product_form', 'enctype'=>'multipart/form-data')) }}
                <div class="row">
					<div class="col-lg-12">
							...
							<div class="panel-heading">
								<h3>
									<div class='pull-right'>
										...
										<a href="{{url('/cms/jungle-stay/entry')}}" class="btn btn-danger btn-sm"><i class="fa fa-remove"></i> Close</a>
									</div>
									Pricing details
								</h3>
							</div>
							<div class="panel-body">
                                ...
                                <div class="form-group">
                    		      	...
                    		      	<div class="col-sm-6 input-group">
                                        ...
                                        <select name="js_id" class="form-control" required>
                                ...
                                <div class="form-group">
                    		      	<label class="control-label col-sm-3" for="pwd">Type<span class="required">*</span></label>
                    		      	<div class="col-sm-6 input-group">

                                        <select name="pricing_id" class="form-control" required>
                                            <option value="">Select type</option>
                                            @foreach($data['entryMaster'] as $key => $row)
                                			         <option value="{{$row['id']}}">{{$row['name']}} {{$row['shortDesc']}}</option>
                                			@endforeach
                                		</select>
